...
func main() {
	...
	r.POST("/suggestion", proxyMiddleware.AuthorizeJWTMiddleware(false), handler.CreateSuggestionRequestHandler())
	r.POST("/feedback", proxyMiddleware.AuthorizeJWTMiddleware(false), handler.CreateSynchronizationFeedbackHandler())
	...
	r.POST("/workgroup", proxyMiddleware.AuthorizeJWTMiddleware(false), handler.CreateWorkgroupHandler())
	...
	r.POST("/workgroup/:id/participation", proxyMiddleware.AuthorizeJWTMiddleware(false), handler.CreateWorkgroupMemberHandler())
