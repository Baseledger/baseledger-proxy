...
func main() {
	...
	r.POST("/workgroup", proxyMiddleware.AuthorizeJWTMiddleware(), handler.CreateWorkgroupHandler())
	...
	r.POST("/workgroup/:id/participation", proxyMiddleware.AuthorizeJWTMiddleware(), handler.CreateWorkgroupMemberHandler())
