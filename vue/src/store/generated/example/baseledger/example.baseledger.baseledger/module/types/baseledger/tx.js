...
const baseMsgCreateBaseledgerTransaction = {
    creator: "",
    baseid: "",
    payload: "",
};
...
const baseMsgUpdateBaseledgerTransaction = {
    creator: "",
    id: 0,
    baseid: "",
    payload: "",
...
export class MsgClientImpl {
    ...
    CreateBaseledgerTransaction(request) {
        ...
        const promise = this.rpc.request("example.baseledger.baseledger.Msg", "CreateBaseledgerTransaction", data);
    ...
    UpdateBaseledgerTransaction(request) {
        ...
        const promise = this.rpc.request("example.baseledger.baseledger.Msg", "UpdateBaseledgerTransaction", data);
    ...
    DeleteBaseledgerTransaction(request) {
        ...
        const promise = this.rpc.request("example.baseledger.baseledger.Msg", "DeleteBaseledgerTransaction", data);
