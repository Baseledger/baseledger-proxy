...
const baseMsgCreateBaseledgerTransaction: object = {
  creator: "",
  baseid: "",
  payload: "",
};
...
export const MsgCreateBaseledgerTransaction = {
  ...
  decode(
    ...
    const message = {
      ...baseMsgCreateBaseledgerTransaction,
    } as MsgCreateBaseledgerTransaction;
  ...
  fromPartial(
    object: DeepPartial<MsgCreateBaseledgerTransaction>
  ): MsgCreateBaseledgerTransaction {
    const message = {
      ...baseMsgCreateBaseledgerTransaction,
    } as MsgCreateBaseledgerTransaction;
...
export const MsgCreateBaseledgerTransactionResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgCreateBaseledgerTransactionResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateBaseledgerTransactionResponse,
    } as MsgCreateBaseledgerTransactionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateBaseledgerTransactionResponse>
  ): MsgCreateBaseledgerTransactionResponse {
    const message = {
      ...baseMsgCreateBaseledgerTransactionResponse,
    } as MsgCreateBaseledgerTransactionResponse;
...
const baseMsgUpdateBaseledgerTransaction: object = {
  creator: "",
  id: 0,
  baseid: "",
  payload: "",
...
export const MsgUpdateBaseledgerTransaction = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateBaseledgerTransaction,
    } as MsgUpdateBaseledgerTransaction;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgUpdateBaseledgerTransaction>
  ): MsgUpdateBaseledgerTransaction {
    const message = {
      ...baseMsgUpdateBaseledgerTransaction,
    } as MsgUpdateBaseledgerTransaction;
...
export const MsgUpdateBaseledgerTransactionResponse = {
  encode(
    _: MsgUpdateBaseledgerTransactionResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgUpdateBaseledgerTransactionResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateBaseledgerTransactionResponse,
    } as MsgUpdateBaseledgerTransactionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateBaseledgerTransactionResponse>
  ): MsgUpdateBaseledgerTransactionResponse {
    const message = {
      ...baseMsgUpdateBaseledgerTransactionResponse,
    } as MsgUpdateBaseledgerTransactionResponse;
...
export const MsgDeleteBaseledgerTransaction = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgDeleteBaseledgerTransaction,
    } as MsgDeleteBaseledgerTransaction;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgDeleteBaseledgerTransaction>
  ): MsgDeleteBaseledgerTransaction {
    const message = {
      ...baseMsgDeleteBaseledgerTransaction,
    } as MsgDeleteBaseledgerTransaction;
...
export const MsgDeleteBaseledgerTransactionResponse = {
  encode(
    _: MsgDeleteBaseledgerTransactionResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgDeleteBaseledgerTransactionResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgDeleteBaseledgerTransactionResponse,
    } as MsgDeleteBaseledgerTransactionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgDeleteBaseledgerTransactionResponse>
  ): MsgDeleteBaseledgerTransactionResponse {
    const message = {
      ...baseMsgDeleteBaseledgerTransactionResponse,
    } as MsgDeleteBaseledgerTransactionResponse;
...
export interface Msg {
  ...
  CreateBaseledgerTransaction(
    request: MsgCreateBaseledgerTransaction
  ): Promise<MsgCreateBaseledgerTransactionResponse>;
  UpdateBaseledgerTransaction(
    request: MsgUpdateBaseledgerTransaction
  ): Promise<MsgUpdateBaseledgerTransactionResponse>;
  DeleteBaseledgerTransaction(
    request: MsgDeleteBaseledgerTransaction
  ): Promise<MsgDeleteBaseledgerTransactionResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateBaseledgerTransaction(
    ...
    const promise = this.rpc.request(
      "example.baseledger.baseledger.Msg",
      "CreateBaseledgerTransaction",
      data
    );
    return promise.then((data) =>
      MsgCreateBaseledgerTransactionResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateBaseledgerTransaction(
    ...
    return promise.then((data) =>
      MsgUpdateBaseledgerTransactionResponse.decode(new Reader(data))
    );
  }
  ...
  DeleteBaseledgerTransaction(
    ...
    return promise.then((data) =>
      MsgDeleteBaseledgerTransactionResponse.decode(new Reader(data))
    );
  }
}
