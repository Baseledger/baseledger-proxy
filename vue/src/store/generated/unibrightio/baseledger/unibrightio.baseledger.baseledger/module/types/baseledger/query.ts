...
const baseQueryGetBaseledgerTransactionRequest: object = { id: '' }

export const QueryGetBaseledgerTransactionRequest = {
  encode(message: QueryGetBaseledgerTransactionRequest, writer: Writer = Writer.create()): Writer {
    if (message.id !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetBaseledgerTransactionRequest {
    ...
    const message = { ...baseQueryGetBaseledgerTransactionRequest } as QueryGetBaseledgerTransactionRequest
...
export const QueryGetBaseledgerTransactionResponse = {
  encode(message: QueryGetBaseledgerTransactionResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetBaseledgerTransactionResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryGetBaseledgerTransactionResponse } as QueryGetBaseledgerTransactionResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const QueryAllBaseledgerTransactionRequest = {
  encode(message: QueryAllBaseledgerTransactionRequest, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryAllBaseledgerTransactionRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryAllBaseledgerTransactionRequest } as QueryAllBaseledgerTransactionRequest
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
export const QueryAllBaseledgerTransactionResponse = {
  encode(message: QueryAllBaseledgerTransactionResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryAllBaseledgerTransactionResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseQueryAllBaseledgerTransactionResponse } as QueryAllBaseledgerTransactionResponse
